    ...
    <>
      ...
      <footer className="relative w-full overflow-hidden" role="contentinfo">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-[#0a0f1a] dark:via-[#0a0f1a] dark:to-[#0a0f1a]">
          ...
          <div
            className="absolute bottom-0 left-1/4 h-64 w-64 md:h-96 md:w-96 rounded-full bg-gradient-to-r from-violet-400 to-purple-300 blur-2xl animate-pulse-glow"
            style={{ animationDelay: "2s" }}
          ></div>
          <div
            className="absolute top-1/3 right-1/4 h-32 w-32 md:h-48 md:w-48 rounded-full bg-gradient-to-r from-indigo-300 to-blue-200 blur-lg animate-pulse-glow"
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16 border-t-4 border-violet-600 dark:border-white/20">
                  ...
                  <div className="rounded-2xl bg-gradient-to-br from-blue-50 via-indigo-50 to-violet-50 dark:from-slate-800 dark:via-slate-800 dark:to-slate-800 p-4 sm:p-6 lg:p-8 shadow-xl border border-blue-100 dark:border-slate-700">
                    ...
                    <div className="mt-3 sm:mt-4 flex justify-center">
                      <div className="relative h-48 w-48 sm:h-48 sm:w-48 overflow-hidden rounded-lg border-4 border-white shadow-md">
                        <img src="/Whatsapp_QR.jpg" alt="WhatsApp QR Code" className="h-full w-full object-cover" />
                      </div>
                    </div>
          ...
          <div className="mt-12 sm:mt-10 lg:mt-12">
            <div className="flex flex-col items-center justify-between border-t border-black dark:border-white/20 pt-6 sm:pt-4 lg:pt-5 md:flex-row">
              ...
              <nav
                className="mt-4 flex flex-wrap justify-center space-x-4 sm:space-x-6 lg:space-x-8 md:mt-0"
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "Leading AI solutions company specializing in machine learning, natural language processing, and intelligent automation",
              ...
              keywords:
                "AI solutions, machine learning, artificial intelligence, data science, automation, NLP, computer vision",
            }),
          }}
        />
      </footer>
